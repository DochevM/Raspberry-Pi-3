...
### Installing Node-Red
Node-RED comes pre-installed on the full Raspbian SD image card. While usable, this uses an older version of Node.js. Its recomended to upgrade it to its lasted vearsion by this command:
```
bash <(curl -sL https://raw.githubusercontent.com/node-red/linux-installers/master/deb/update-nodejs-and-nodered)
```
From then follow the steps.

Ten you can start Node-Red by:
```
node-red-start
```
Yoh can connect to Node-red with a browser by:
